...
- **A visual and a word-class label on every vocabulary card.** There are now 1,344 original semantic SVG cues across nouns, verbs, adjectives, adverbs and expressions, plus 52 original AI-assisted action scenes; other cards use a pictogram/emoji or a consistent structural vector. Symbols are memory cues, not definitions; 4.12 corrects Nachteil, Meinung and Schachbrett and removes a wrong-sense Maulwurf drawing. Nouns also show der/die/das colour and gender. See `docs/VOCAB_ICONS.md`
