...
| --- | ---: | --- | --- |
| Authored SVG drawings | 1,280 | hand-drawn and reviewed | own work, MIT |
...
| **Direct semantic SVG coverage** | **12.80% of the deck** | | |
| Deck | 10,000 | | |

Before this work: 598 of 10,000, or 6%. Direct authored SVG coverage is now
1,280 cards, and compound, emoji, line-icon and motion tiers extend useful cues
...
| Drawn (4.10.1-4.10.4) | 63 | 69 |
| Declined with a reason | 2 | 3 |
| Carried forward | 0 | 59 |

The 59 still waiting are a real backlog rather than a wish list -- each was
checked against the deck and against the drawn set. Among them: Aequator,
Kugel, Rechteck and Winkel (which finish the shape set beside Quadrat and
Dreieck), Sonnenfinsternis, Sonnenuhr, Parkuhr, Peruecke, Wanne, Waeschekorb,
Weinkeller, Wespe, Tarantel, Schimpanse, Sauna, Savanne, Ruine, Roulette,
Reisepass, Praline, Teebeutel, Zahnspange, Ziellinie, Strassensperre,
Tuergriff, Schluesselloch, Schutzhelm, Stereoanlage, Fotoalbum, Fuhrwerk,
Gasherd, Irrgarten, Kaffeekanne, Oelquelle and Vogelhaus.
...
Blumenkohl beside Kohlkopf, Oboe beside Klarinette. At 1,280 drawings the
