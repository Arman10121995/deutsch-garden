...
| --- | ---: | --- | --- |
| Authored SVG drawings | 1,316 | hand-drawn and reviewed | own work, MIT |
...
| **Direct semantic SVG coverage** | **13.16% of the deck** | | |
| Deck | 10,000 | | |

Before this work: 598 of 10,000, or 6%. Direct authored SVG coverage is now
1,316 cards, and compound, emoji, line-icon and motion tiers extend useful cues
...
| Drawn (4.10.1-4.10.5) | 63 | 105 |
| Declined with a reason | 2 | 3 |
| Carried forward | 0 | 23 |

The 23 still waiting are what is left of the backlog, and they are the weaker
end of it: Badeanzug, Butterbrot, Buehne, Fotoalbum, Grabmal, Halskette,
Heuhaufen, Korsett, Kreisverkehr, Lasagne, Lichtschalter, Rindfleisch, Ruine,
Savanne, Stemmeisen, Stereoanlage and Strassensperre among them. Several were
held back for collisions rather than for difficulty -- Halskette next to the
Medaille already drawn, Heuhaufen next to Brennholz, Fingerhut next to
Salzstreuer.
...
Blumenkohl beside Kohlkopf, Oboe beside Klarinette. At 1,316 drawings the
