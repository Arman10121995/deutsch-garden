...
| --- | ---: | --- | --- |
| Authored SVG drawings | 1,339 | hand-drawn and reviewed | own work, MIT |
...
| **Direct semantic SVG coverage** | **13.39% of the deck** | | |
| Deck | 10,000 | | |

Before this work: 598 of 10,000, or 6%. Direct authored SVG coverage is now
1,339 cards, and compound, emoji, line-icon and motion tiers extend useful cues
