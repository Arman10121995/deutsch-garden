...
const List<ConversationScenario> _foundationScenarios = <ConversationScenario>[
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['kaffee', 'tee', 'wasser', 'saft', 'hätte gern', 'möchte', 'bitte'],
      ...
      DialogueStep(
        ...
        keywords: <String>['brötchen', 'kuchen', 'brot', 'käse', 'nein danke', 'ja', 'hätte gern', 'möchte'],
      ...
      DialogueStep(
        ...
        keywords: <String>['hier', 'mitnehmen', 'zum mitnehmen', 'bleibe', 'bitte'],
        ...
        coachTip: 'Short answers are normal here — a full sentence is optional.',
      ),
      DialogueStep(
        tutorGerman: 'Alles klar. Der Kaffee kostet drei Euro zwanzig. Noch etwas?',
        tutorEnglish: 'All right. The coffee is three euros twenty. Anything else?',
      ...
      DialogueStep(
        ...
        keywords: <String>['danke', 'tschüss', 'wiedersehen', 'ebenfalls', 'gleichfalls'],
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      ...
      DialogueStep(
        ...
        keywords: <String>['arbeite', 'student', 'studiere', 'ingenieur', 'bin'],
      ...
      DialogueStep(
        ...
        keywords: <String>['weil', 'für', 'arbeit', 'studium', 'lerne', 'möchte'],
        minWords: 4,
      ...
      DialogueStep(
        ...
        keywords: <String>['ja', 'gern', 'gerne', 'super', 'nein', 'vielleicht'],
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      ...
      DialogueStep(
        tutorGerman: 'Die Milch ist hinten rechts, neben dem Käse. Brauchen Sie noch etwas?',
        tutorEnglish: 'The milk is at the back on the right, next to the cheese. Do you need anything else?',
        ...
        quickReplies: <String>['Haben Sie frisches Brot?', 'Gibt es hier Brot?'],
        coachTip: 'Yes/no questions start with the verb: *Haben* Sie …?',
      ),
      DialogueStep(
        tutorGerman: 'Ja, das Brot kommt jeden Morgen frisch. Es liegt vorne links.',
        tutorEnglish: 'Yes, the bread arrives fresh every morning. It is at the front on the left.',
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['halsschmerzen', 'seit', 'weh', 'schmerzen', 'krank', 'tagen'],
        requiredHits: 2,
        minWords: 5,
      ...
      DialogueStep(
        ...
        keywords: <String>['fieber', 'ja', 'nein', 'grad', 'gestern', 'gemessen'],
        requiredHits: 2,
        minWords: 4,
      ...
      DialogueStep(
        ...
        keywords: <String>['nehme', 'tabletten', 'nein', 'nichts', 'medikament', 'ibuprofen'],
        minWords: 3,
      ...
      DialogueStep(
        ...
        tutorEnglish: 'Good. I will prescribe a spray. Use it three times a day.',
        task: 'Check that you understood — repeat the instruction as a question.',
        keywords: <String>['dreimal', 'täglich', 'also', 'richtig', 'tag', 'wie lange'],
        requiredHits: 2,
      ...
      DialogueStep(
        ...
        keywords: <String>['danke', 'vielen dank', 'wiedersehen', 'tschüss', 'alles klar'],
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Herzlich willkommen. Das ist das Wohnzimmer. Wie gefällt Ihnen die Wohnung?',
        tutorEnglish: 'Welcome. This is the living room. How do you like the flat?',
      ...
      DialogueStep(
        ...
        keywords: <String>['nebenkosten', 'warm', 'inklusive', 'dazu', 'extra', 'strom'],
        requiredHits: 2,
        modelAnswer: 'Sind die Nebenkosten inklusive oder kommen sie noch dazu?',
        modelAnswerEnglish: 'Are the utilities included or do they come on top?',
        quickReplies: <String>['Sind die Nebenkosten inklusive?', 'Was kostet die Warmmiete?'],
        coachTip: 'Kaltmiete = rent alone. Warmmiete = rent plus Nebenkosten.',
      ),
      DialogueStep(
        tutorGerman: 'Die Nebenkosten betragen 150 Euro zusätzlich. Strom zahlen Sie selbst.',
        tutorEnglish: 'Utilities are 150 euros on top. You pay for electricity yourself.',
      ...
      DialogueStep(
        ...
        tutorEnglish: 'From the first of October. Would you like to know anything else?',
        task: 'Ask about one rule — pets, smoking or the deposit.',
        keywords: <String>['kaution', 'haustiere', 'rauchen', 'darf', 'erlaubt', 'waschmaschine'],
        requiredHits: 2,
        modelAnswer: 'Ja, wie hoch ist die Kaution? Und sind Haustiere erlaubt?',
        modelAnswerEnglish: 'Yes, how high is the deposit? And are pets allowed?',
        quickReplies: <String>['Wie hoch ist die Kaution?', 'Sind Haustiere erlaubt?'],
        coachTip: 'A Kaution of up to three months\' Kaltmiete is standard in Germany.',
      ),
      DialogueStep(
        tutorGerman: 'Zwei Kaltmieten Kaution, Haustiere nach Absprache. Interesse?',
        tutorEnglish: 'Two months\' base rent as deposit, pets by agreement. Interested?',
        task: 'Express interest and propose a next step.',
        keywords: <String>['interesse', 'gern', 'melde', 'unterlagen', 'ja', 'überlegen'],
        requiredHits: 2,
        minWords: 5,
        modelAnswer: 'Ja, ich habe großes Interesse. Ich schicke Ihnen morgen meine Unterlagen.',
        modelAnswerEnglish: 'Yes, I am very interested. I will send you my documents tomorrow.',
        quickReplies: <String>['Ja, ich habe Interesse.', 'Ich möchte es mir noch überlegen.'],
        coachTip: 'Closing with a concrete next step is what gets you the flat.',
      ),
    ],
  ),
  ConversationScenario(
    ...
    emoji: '🚆',
    title: 'Am Bahnhof',
    setting: 'You need to get to Berlin this afternoon and your train is cancelled.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['zug', 'ausgefallen', 'problem', 'berlin', 'gestrichen', 'nicht'],
        requiredHits: 2,
        minWords: 5,
      ...
      DialogueStep(
        ...
        keywords: <String>['heute', 'nachmittag', 'uhr', 'abend', 'muss', 'spätestens'],
        requiredHits: 2,
        minWords: 4,
      ...
      DialogueStep(
        ...
        quickReplies: <String>['Muss ich umsteigen?', 'Ist das eine direkte Verbindung?'],
        coachTip: 'umsteigen = change trains; einsteigen = board; aussteigen = get off.',
      ),
      DialogueStep(
        tutorGerman: 'Sie steigen einmal in Hamburg um, dort haben Sie zwölf Minuten.',
        tutorEnglish: 'You change once in Hamburg, where you have twelve minutes.',
        task: 'Ask what the ticket costs.',
        keywords: <String>['kostet', 'fahrkarte', 'ticket', 'preis', 'wie viel'],
        requiredHits: 2,
        modelAnswer: 'Alles klar. Was kostet die Fahrkarte?',
        modelAnswerEnglish: 'All right. What does the ticket cost?',
        quickReplies: <String>['Was kostet die Fahrkarte?', 'Wie viel kostet das Ticket?'],
        coachTip: 'die Fahrkarte / das Ticket — both are used at the counter.',
      ),
      DialogueStep(
        tutorGerman: 'Ihre alte Fahrkarte gilt weiter, Sie zahlen nichts extra.',
      ...
      DialogueStep(
        ...
        keywords: <String>['danke', 'vielen dank', 'tschüss', 'wiedersehen', 'geholfen'],
...
const List<ConversationScenario> _independentScenarios = <ConversationScenario>[
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Schön, dass Sie da sind. Erzählen Sie doch kurz etwas über sich.',
        tutorEnglish: 'Good to have you here. Tell us a bit about yourself.',
        task: 'Give a structured 3-sentence self-presentation: education, current role, focus.',
        keywords: <String>['studiert', 'arbeite', 'erfahrung', 'zurzeit', 'jahre', 'abschluss'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Gern. Ich habe Maschinenbau studiert und arbeite zurzeit als Prozessingenieur. '
        ...
        modelAnswerEnglish: 'Gladly. I studied mechanical engineering and currently work as a process engineer. '
        ...
        coachTip: 'Three sentences beats one long one: background → present role → focus.',
      ),
      DialogueStep(
        ...
        keywords: <String>['weil', 'da', 'außerdem', 'interessiert', 'passt', 'entwickeln'],
        requiredHits: 3,
        minWords: 16,
        modelAnswer: 'Ich habe mich beworben, weil Ihr Unternehmen stark in der Automatisierung ist. '
      ...
      DialogueStep(
        ...
        keywords: <String>['schwäche', 'früher', 'inzwischen', 'daran', 'arbeite', 'gelernt', 'versuche', 'delegiere', 'plane', 'aufgaben'],
        requiredHits: 3,
        minWords: 16,
        modelAnswer: 'Früher habe ich zu viele Aufgaben selbst übernommen. '
            'Inzwischen delegiere ich bewusst und plane Zwischenschritte fest ein.',
        modelAnswerEnglish: 'In the past I took on too many tasks myself. '
            'Now I deliberately delegate and plan intermediate steps.',
        quickReplies: <String>['Manchmal … . Daran arbeite ich, indem ich …'],
        coachTip: 'Structure: weakness → concrete counter-measure. Never end on the weakness.',
      ),
      DialogueStep(
        ...
        keywords: <String>['priorisiere', 'priorität', 'zuerst', 'plane', 'kritisch', 'zum beispiel', 'abstimmung', 'absprache'],
        requiredHits: 3,
        minWords: 16,
        modelAnswer: 'Ich priorisiere zuerst und kläre früh, was wirklich kritisch ist. '
            'Als wir letztes Jahr eine Anlage umbauen mussten, habe ich zum Beispiel täglich kurze Abstimmungen eingeführt.',
        modelAnswerEnglish: 'I prioritise first and clarify early what is really critical. '
            'When we had to rebuild a plant last year, for example, I introduced short daily check-ins.',
        quickReplies: <String>['Ich priorisiere zuerst und …', 'Zum Beispiel habe ich …'],
        coachTip: 'A concrete example beats an abstract claim in every German interview.',
      ),
      DialogueStep(
        ...
        keywords: <String>['vorstellung', 'euro', 'bereich', 'erfahrung', 'zwischen', 'brutto'],
        requiredHits: 2,
        minWords: 12,
        modelAnswer: 'Auf Basis meiner Erfahrung liegt meine Vorstellung zwischen 58.000 und 62.000 Euro brutto im Jahr.',
        modelAnswerEnglish: 'Based on my experience my expectation is between 58,000 and 62,000 euros gross per year.',
        quickReplies: <String>['Meine Vorstellung liegt zwischen … und … Euro.'],
      ...
      DialogueStep(
        ...
        keywords: <String>['team', 'einarbeitung', 'projekt', 'könnten sie', 'wie', 'weiterbildung'],
        requiredHits: 2,
        minWords: 12,
        modelAnswer: 'Ja, zwei Fragen: Wie ist das Team aufgestellt? Und wie sieht die Einarbeitung in den ersten Monaten aus?',
        modelAnswerEnglish: 'Yes, two questions: How is the team set up? And what does onboarding look like in the first months?',
        quickReplies: <String>['Wie ist das Team aufgestellt?', 'Wie sieht die Einarbeitung aus?'],
        coachTip: 'Having no questions is read as a lack of interest — always prepare two.',
      ),
    ],
  ),
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['anmelden', 'wohnung', 'seit', 'umgezogen', 'adresse'],
        requiredHits: 2,
        minWords: 8,
        modelAnswer: 'Guten Tag. Ich möchte mich anmelden. Ich bin vor zwei Wochen umgezogen.',
        modelAnswerEnglish: 'Hello. I would like to register. I moved two weeks ago.',
        quickReplies: <String>['Ich möchte mich anmelden.', 'Ich bin vor zwei Wochen umgezogen.'],
        coachTip: 'sich anmelden is reflexive: Ich melde *mich* an.',
      ),
      DialogueStep(
        tutorGerman: 'Haben Sie die Wohnungsgeberbestätigung und Ihren Ausweis dabei?',
        tutorEnglish: 'Do you have the landlord confirmation and your ID with you?',
        task: 'Say you have one document but not the other.',
        keywords: <String>['ausweis', 'bestätigung', 'leider', 'nicht', 'dabei', 'nur'],
        requiredHits: 3,
        minWords: 10,
      ...
      DialogueStep(
        ...
        tutorEnglish: 'Without the confirmation I cannot complete the registration.',
        task: 'Ask politely whether you can hand it in later.',
        keywords: <String>['nachreichen', 'später', 'möglich', 'könnte', 'wäre', 'per e-mail'],
        requiredHits: 2,
        minWords: 10,
      ...
      DialogueStep(
        ...
        tutorEnglish: 'Submitting later is unfortunately not possible. But you can book a new appointment.',
        task: 'Explain your problem: the deadline is in a few days.',
        keywords: <String>['frist', 'zwei wochen', 'problem', 'muss', 'strafe', 'termin'],
        requiredHits: 2,
        minWords: 12,
      ...
      DialogueStep(
        ...
        keywords: <String>['dienstag', 'neun', 'nehme', 'passt', 'gern', 'bestätigen'],
        requiredHits: 2,
        minWords: 8,
        modelAnswer: 'Den nehme ich gern. Also Dienstag um neun Uhr — bekomme ich eine Bestätigung?',
        modelAnswerEnglish: 'I will gladly take it. So Tuesday at nine — will I get a confirmation?',
        quickReplies: <String>['Den Termin nehme ich gern.', 'Bekomme ich eine Bestätigung?'],
        coachTip: 'Repeating the date back prevents the classic Amt misunderstanding.',
      ),
      DialogueStep(
        tutorGerman: 'Sie bekommen sie per E-Mail. Bringen Sie bitte alle Unterlagen mit.',
        tutorEnglish: 'You will get it by email. Please bring all documents with you.',
        task: 'Confirm what you will bring and thank her.',
        keywords: <String>['bringe', 'mit', 'ausweis', 'bestätigung', 'danke', 'unterlagen'],
        requiredHits: 3,
        minWords: 10,
        modelAnswer: 'Alles klar, ich bringe den Ausweis und die Wohnungsgeberbestätigung mit. Vielen Dank für Ihre Hilfe.',
        modelAnswerEnglish: 'All right, I will bring my ID and the landlord confirmation. Thank you very much for your help.',
  ...
  ConversationScenario(
    ...
    setting: 'Your neighbour plays loud music late at night. You knock on the door.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['entschuldigung', 'musik', 'laut', 'geht um', 'stört', 'abend'],
        requiredHits: 3,
        minWords: 12,
      ...
      DialogueStep(
        ...
        keywords: <String>['gestern', 'uhr', 'jeden', 'oft', 'mitternacht', 'seit'],
        requiredHits: 2,
        minWords: 12,
      ...
      DialogueStep(
        ...
        tutorEnglish: 'I work during the day, in the evening I just want to relax.',
        task: 'Show understanding, then state your own need.',
        keywords: <String>['verstehe', 'nachvollziehen', 'aber', 'trotzdem', 'früh', 'schlafen'],
        requiredHits: 3,
        minWords: 14,
      ...
      DialogueStep(
        ...
        tutorEnglish: 'And what am I supposed to do now? Switch the music off entirely?',
        task: 'Propose a concrete, realistic compromise.',
        keywords: <String>['vorschlag', 'ab', 'uhr', 'leiser', 'kopfhörer', 'könnten wir'],
        requiredHits: 2,
        minWords: 12,
        modelAnswer: 'Mein Vorschlag wäre: ab zweiundzwanzig Uhr etwas leiser oder mit Kopfhörern. Wäre das machbar?',
        modelAnswerEnglish: 'My suggestion would be: a bit quieter after ten p.m. or with headphones. Would that be doable?',
        quickReplies: <String>['Könnten wir vereinbaren, dass es ab 22 Uhr leiser ist?'],
        coachTip: 'German law recognises Nachtruhe from 22:00 — naming it makes the request reasonable.',
      ),
      DialogueStep(
        ...
        keywords: <String>['abgemacht', 'einverstanden', 'super', 'freut', 'vereinbart', 'danke'],
        requiredHits: 2,
        minWords: 8,
      ...
      DialogueStep(
        ...
        keywords: <String>['gilt', 'auch', 'natürlich', 'danke', 'gute nacht', 'ebenso'],
        requiredHits: 2,
        minWords: 8,
        modelAnswer: 'Mache ich — und das gilt natürlich auch umgekehrt. Gute Nacht!',
        modelAnswerEnglish: 'I will — and of course that goes both ways. Good night!',
        quickReplies: <String>['Das gilt natürlich auch umgekehrt.', 'Danke, gute Nacht!'],
        coachTip: 'Offering reciprocity turns a complaint into a neighbourly relationship.',
      ),
    ],
  ),
  ...
  ConversationScenario(
    ...
    setting: 'A project meeting. A deadline is at risk and you must propose a plan.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['stand', 'verzögerung', 'risiko', 'prozent', 'fertig', 'allerdings'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Das Modul ist zu etwa achtzig Prozent fertig. Allerdings zeichnet sich eine Verzögerung ab, '
            'weil die Schnittstelle später geliefert wurde als geplant.',
        modelAnswerEnglish: 'The module is about eighty percent complete. However, a delay is emerging '
            'because the interface was delivered later than planned.',
        quickReplies: <String>['Das Modul ist zu 80 % fertig, allerdings …'],
        coachTip: 'Status first, risk second, cause third — that order keeps the room calm.',
      ),
      DialogueStep(
        ...
        keywords: <String>['woche', 'tage', 'schätze', 'voraussichtlich', 'davon aus', 'realistisch'],
        requiredHits: 2,
        minWords: 14,
      ...
      DialogueStep(
        ...
        keywords: <String>['widersprechen', 'einarbeitung', 'eingearbeitet', 'kurzfristig', 'allerdings', 'problem', 'nicht'],
        requiredHits: 2,
        minWords: 18,
        modelAnswer: 'Dem würde ich insofern widersprechen, als zusätzliche Personen zunächst eingearbeitet werden müssten. '
      ...
      DialogueStep(
        ...
        keywords: <String>['schlage vor', 'erstens', 'zweitens', 'priorisieren', 'zunächst', 'anschließend'],
        requiredHits: 3,
        minWords: 20,
        modelAnswer: 'Ich schlage vor, dass wir erstens den Funktionsumfang für das erste Release reduzieren '
      ...
      DialogueStep(
        ...
        keywords: <String>['falls', 'sollte', 'dann', 'müssten', 'würde', 'termin'],
        requiredHits: 2,
        minWords: 16,
        modelAnswer: 'Sollte der Kunde darauf bestehen, müssten wir den Termin gemeinsam verschieben. '
      ...
      DialogueStep(
        ...
        task: 'Summarise the decision and the next step with an owner and a date.',
        keywords: <String>['zusammenfassend', 'wir haben', 'bis', 'übernehme', 'nächster schritt', 'freitag'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Zusammenfassend: Wir reduzieren den Umfang des ersten Releases und testen parallel. '
            'Ich stimme das bis Freitag mit dem Kunden ab.',
        modelAnswerEnglish: 'To summarise: we reduce the scope of the first release and test in parallel. '
            'I will align this with the client by Friday.',
        quickReplies: <String>['Zusammenfassend: wir … . Ich übernehme … bis …'],
...
const List<ConversationScenario> _advancedScenarios = <ConversationScenario>[
  ConversationScenario(
    ...
    setting: 'A delivered machine part is defective and the supplier is evasive.',
    tutorRole: 'Kundendienstmitarbeiter (customer service agent)',
    learnerRole: 'Kunde (business customer)',
    goal: 'Assert your claim firmly, stay polite, and secure a binding commitment.',
    usefulPhrases: <String>[
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['beziehe mich', 'lieferung', 'mangel', 'defekt', 'bestellung', 'nummer'],
        requiredHits: 3,
        minWords: 16,
        modelAnswer: 'Guten Tag. Ich beziehe mich auf die Lieferung vom fünften März, Auftragsnummer 4471. '
      ...
      DialogueStep(
        ...
        keywords: <String>['fachgerecht', 'nach anleitung', 'dokumentiert', 'protokoll', 'ausschließen', 'geprüft'],
        requiredHits: 3,
        minWords: 16,
        modelAnswer: 'Die Montage erfolgte fachgerecht und nach Ihrer Anleitung; das ist im Prüfprotokoll dokumentiert. '
      ...
      DialogueStep(
        ...
        tutorEnglish: 'I would have to have that checked internally. That may take several weeks.',
        task: 'Push back on the timeline and name the consequence.',
        keywords: <String>['stillstand', 'produktion', 'kosten', 'nicht hinnehmbar', 'kurzfristig', 'frist'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Mehrere Wochen sind für uns nicht hinnehmbar, da die Anlage stillsteht und täglich Kosten entstehen. '
            'Ich bitte um eine Rückmeldung innerhalb von fünf Werktagen.',
        modelAnswerEnglish: 'Several weeks are unacceptable for us, as the plant is idle and costs accrue daily. '
            'I request a response within five working days.',
        quickReplies: <String>['Das ist für uns nicht hinnehmbar, da …'],
        coachTip: 'Naming a concrete deadline converts a complaint into a claim.',
      ),
      DialogueStep(
        ...
        keywords: <String>['einigen', 'kompromiss', 'ersatzteil', 'zwischenlösung', 'vorab', 'akzeptieren'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Dann einigen wir uns auf eine Woche, sofern Sie vorab ein Ersatzteil als Zwischenlösung versenden. '
      ...
      DialogueStep(
        ...
        keywords: <String>['halten wir fest', 'zusammenfassend', 'dank', 'melde', 'somit', 'vereinbart', 'ersatzteil', 'bestätigung'],
        requiredHits: 2,
        minWords: 16,
        modelAnswer: 'Halten wir fest: Ersatzteil morgen, Prüfergebnis in einer Woche, Bestätigung heute per E-Mail. '
  ...
  ConversationScenario(
    ...
    steps: <DialogueStep>[
      DialogueStep(
        ...
        keywords: <String>['da ist etwas dran', 'allerdings', 'differenzierter', 'pauschal', 'sehe ich', 'jedoch'],
        requiredHits: 2,
        minWords: 16,
        modelAnswer: 'Da ist etwas dran, allerdings sehe ich das differenzierter. Pauschal lässt sich das nicht sagen, '
            'weil es stark von der Führung abhängt.',
        modelAnswerEnglish: 'There is something to that, but I see it in a more differentiated way. It cannot be said across the board, '
            'because it depends heavily on leadership.',
        quickReplies: <String>['Da ist etwas dran, allerdings …'],
        coachTip: 'Concede-then-qualify is how educated German disagreement works.',
      ),
      DialogueStep(
        tutorGerman: 'Aber spontane Gespräche entstehen doch nur im Büro.',
        tutorEnglish: 'But spontaneous conversations only happen in the office.',
        task: 'Make a distinction rather than a flat denial.',
        keywords: <String>['unterscheiden', 'zwischen', 'einerseits', 'andererseits', 'zufällig', 'strukturiert'],
        requiredHits: 2,
        minWords: 18,
        modelAnswer: 'Man muss zwischen zufälligem Austausch und strukturierter Zusammenarbeit unterscheiden. '
      ...
      DialogueStep(
        ...
        keywords: <String>['studien', 'kommen zu', 'unterschiedlich', 'kaum belegen', 'methodisch', 'hängt davon ab'],
        requiredHits: 2,
        minWords: 18,
        modelAnswer: 'Die Studienlage ist uneinheitlich; verschiedene Untersuchungen kommen zu gegenläufigen Ergebnissen. '
            'Methodisch hängt viel davon ab, wie Produktivität überhaupt gemessen wird.',
        modelAnswerEnglish: 'The evidence is mixed; different studies reach opposing results. '
        ...
        coachTip: 'Attacking the operationalisation is stronger than denying the finding.',
      ),
      DialogueStep(
        ...
        keywords: <String>['darum geht es nicht', 'sachlich', 'persönlich', 'zurückkommen', 'frage', 'eigentlich'],
        requiredHits: 2,
        minWords: 14,
      ...
      DialogueStep(
        ...
        keywords: <String>['vorschlag', 'tage', 'fest', 'evaluieren', 'pilot', 'monaten'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Mein Vorschlag wäre ein Pilot: zwei feste Bürotage pro Woche für das ganze Team, '
            'nach drei Monaten gemeinsam evaluiert.',
        modelAnswerEnglish: 'My proposal would be a pilot: two fixed office days a week for the whole team, '
      ...
      DialogueStep(
        ...
        keywords: <String>['freut mich', 'gemeinsam', 'vorschlagen', 'runde', 'dann', 'einbringen'],
        requiredHits: 2,
        minWords: 12,
        modelAnswer: 'Das freut mich. Dann bringen wir den Vorschlag gemeinsam in die nächste Teamrunde ein.',
        modelAnswerEnglish: 'I am glad. Then let us bring the proposal into the next team meeting together.',
        quickReplies: <String>['Dann bringen wir das gemeinsam ein.'],
        coachTip: 'Ending with joint ownership prevents the argument from resurfacing.',
      ),
    ],
  ),
  ...
  ConversationScenario(
    ...
    setting: 'A panel discussion. You are the invited expert; the host presses you.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Zerstört künstliche Intelligenz das eigenständige Denken der Schüler?',
        tutorEnglish: 'Is artificial intelligence destroying pupils\' independent thinking?',
        task: 'Reject the framing and reformulate the question.',
        keywords: <String>['differenzieren', 'weniger', 'vielmehr', 'frage', 'unter welchen bedingungen', 'pauschal'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Ich würde zunächst differenzieren. Die Frage ist weniger, ob KI das Denken zerstört, '
      ...
      DialogueStep(
        ...
        keywords: <String>['verkürzung', 'zulässig', 'sachverhalt', 'komplex', 'gerecht', 'seriös'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Eine solche Verkürzung würde dem Sachverhalt nicht gerecht. Seriös lässt sich nur sagen: '
      ...
      DialogueStep(
        ...
        tutorEnglish: 'But teachers report that homework has become practically worthless.',
        task: 'Take the observation seriously and reinterpret it.',
        keywords: <String>['beobachtung', 'ernst', 'hinweis', 'aufgabenformat', 'weniger', 'verlagert'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Diese Beobachtung nehme ich ernst, deute sie aber anders: Sie ist weniger ein Hinweis auf die Technologie '
            'als auf ein Aufgabenformat, das reproduzierbares Wissen abfragt. Die Prüfungslogik verlagert sich.',
        modelAnswerEnglish: 'I take that observation seriously but interpret it differently: it points less to the technology '
        ...
        coachTip: 'Reinterpreting rather than denying evidence is the hallmark of an expert register.',
      ),
      DialogueStep(
        tutorGerman: 'Sie verlangen also, dass Lehrkräfte alles umstellen. Ist das realistisch?',
        tutorEnglish: 'So you are demanding teachers change everything. Is that realistic?',
        task: 'Concede the constraint and name the precondition.',
        keywords: <String>['setzt voraus', 'ressourcen', 'zugestehen', 'nicht über nacht', 'fortbildung', 'zweifellos'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Zweifellos ist das nicht über Nacht zu leisten, und das muss man zugestehen. '
      ...
      DialogueStep(
        ...
        keywords: <String>['verbot', 'kaum durchsetzbar', 'verlagert', 'kontrolle', 'stattdessen', 'kompetenz'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Ein Verbot wäre kaum durchsetzbar und würde die Nutzung lediglich aus dem Blickfeld der Schule verlagern. '
            'Sinnvoller erscheint mir, Kompetenz im Umgang systematisch aufzubauen.',
        modelAnswerEnglish: 'A ban would hardly be enforceable and would merely shift usage out of the school\'s view. '
        ...
        coachTip: 'Attack feasibility first, desirability second — it is harder to dismiss.',
      ),
      DialogueStep(
        ...
        keywords: <String>['entscheidend', 'nicht ob', 'sondern wie', 'letztlich', 'verantwortung', 'gestaltung'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Entscheidend ist nicht, ob wir diese Werkzeuge einsetzen, sondern wie wir sie didaktisch einbetten. '
  ...
  ConversationScenario(
    ...
    setting: 'An annual review. You want a significant raise; your manager resists.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Sie wollten über Ihre Vergütung sprechen. Womit fangen wir an?',
        tutorEnglish: 'You wanted to talk about your compensation. Where do we start?',
        task: 'Open with your contribution, not your demand.',
        keywords: <String>['jahr', 'verantwortung', 'übernommen', 'ergebnis', 'projekt', 'entwickelt'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Am besten mit dem vergangenen Jahr: Ich habe die Verantwortung für zwei zusätzliche Anlagen übernommen '
            'und die Ausfallzeiten messbar reduziert. Darauf möchte ich meine Vorstellung stützen.',
        modelAnswerEnglish: 'Best with the past year: I took on responsibility for two additional plants '
        ...
        coachTip: 'Establish value before naming a number; the number then sounds derived, not demanded.',
      ),
      DialogueStep(
        ...
        keywords: <String>['halte ich', 'angemessen', 'gemessen an', 'prozent', 'markt', 'euro'],
        requiredHits: 3,
        minWords: 20,
      ...
      DialogueStep(
        ...
        keywords: <String>['nachvollziehbar', 'gleichwohl', 'entkoppeln', 'leistung', 'budget', 'unabhängig'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Der Budgetrahmen ist nachvollziehbar. Gleichwohl würde ich die Bewertung meiner Leistung ungern '
      ...
      DialogueStep(
        ...
        keywords: <String>['sofern', 'darüber ließe sich reden', 'unter der voraussetzung', 'zusätzlich', 'überprüfung', 'halbjahr'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Darüber ließe sich reden, sofern wir eine Überprüfung nach sechs Monaten schriftlich vereinbaren '
            'und die zusätzliche Anlagenverantwortung formal im Vertrag abgebildet wird.',
        modelAnswerEnglish: 'That could be discussed, provided we agree in writing on a review after six months '
        ...
        coachTip: 'Trading a lower number for a written review is the standard German counter-move.',
      ),
      DialogueStep(
        tutorGerman: 'Eine schriftliche Zusage für eine Überprüfung ist unüblich.',
        tutorEnglish: 'A written commitment to a review is unusual.',
        task: 'Normalise your request and stay firm.',
        keywords: <String>['üblich', 'protokoll', 'aktenvermerk', 'unproblematisch', 'lediglich', 'festhalten'],
        requiredHits: 3,
        minWords: 20,
        modelAnswer: 'Es genügt mir ein kurzer Aktenvermerk im Protokoll. Das ist organisatorisch unproblematisch '
      ...
      DialogueStep(
        ...
        tutorEnglish: 'Fine. Six percent now, review noted in the minutes. Agreed?',
        task: 'Accept, restate the terms exactly, and set the date.',
        keywords: <String>['einverstanden', 'festhalten', 'ab', 'überprüfung', 'protokoll', 'danke'],
        requiredHits: 3,
        minWords: 18,
        modelAnswer: 'Einverstanden. Halten wir fest: sechs Prozent ab dem ersten des kommenden Monats, '
            'Überprüfung nach sechs Monaten, im Protokoll vermerkt. Danke für das offene Gespräch.',
        modelAnswerEnglish: 'Agreed. Let us record: six percent from the first of next month, '
        ...
        coachTip: 'Never leave a negotiation without repeating the terms out loud.',
      ),
    ],
  ),
  ...
  ConversationScenario(
    ...
    setting: 'A journalist interviews you about anonymous sources and public interest.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Rechtfertigt öffentliches Interesse jeden Vertrauensbruch?',
        tutorEnglish: 'Does public interest justify any breach of confidence?',
        task: 'Reject the absolute and set up the trade-off.',
        keywords: <String>['zielkonflikt', 'kontextabhängig', 'abwägung', 'keineswegs', 'verhältnismäßig', 'zwischen'],
        requiredHits: 3,
        minWords: 26,
        modelAnswer: 'Keineswegs. Hier liegt ein Zielkonflikt vor zwischen dem Schutz vertraulicher Beziehungen '
            'und dem Informationsanspruch der Öffentlichkeit; entscheidend ist eine Verhältnismäßigkeitsprüfung im Einzelfall.',
        modelAnswerEnglish: 'By no means. There is a conflict of goals here between protecting confidential relationships '
            'and the public\'s claim to information; what matters is a proportionality assessment case by case.',
        quickReplies: <String>['Hier liegt ein Zielkonflikt vor zwischen … und …'],
        coachTip: 'Naming the conflict of goals immediately signals analytical control.',
      ),
      DialogueStep(
        tutorGerman: 'Das klingt bequem. Wer entscheidet denn über die Verhältnismäßigkeit?',
        ...
        keywords: <String>['redaktion', 'nachvollziehbar', 'dokumentiert', 'rechenschaft', 'verfahren', 'nachträglich'],
        requiredHits: 3,
        minWords: 26,
        modelAnswer: 'Zunächst die Redaktion, allerdings nicht willkürlich: Die Abwägung muss dokumentiert, begründet '
      ...
      DialogueStep(
        ...
        tutorEnglish: 'Critics say media ethics is self-soothing without consequence.',
        task: 'Concede the partial truth, then rebut the generalisation.',
        keywords: <String>['teilweise', 'berechtigt', 'unzulässige verallgemeinerung', 'gleichwohl', 'sanktion', 'wirkung'],
        requiredHits: 3,
        minWords: 26,
        modelAnswer: 'Teilweise ist der Vorwurf berechtigt, sofern Selbstverpflichtungen ohne jede Sanktion bleiben. '
            'Als Pauschalurteil wäre er gleichwohl eine unzulässige Verallgemeinerung — dokumentierte Rügen entfalten durchaus Wirkung.',
        modelAnswerEnglish: 'The reproach is partly justified insofar as self-commitments remain without any sanction. '
            'As a blanket judgement it would nevertheless be an inadmissible generalisation — documented reprimands do have an effect.',
        quickReplies: <String>['Teilweise berechtigt, als Pauschalurteil aber …'],
        coachTip: 'Splitting a criticism into its valid and invalid halves is a signature C2 move.',
      ),
      DialogueStep(
        tutorGerman: 'Angenommen, eine Quelle hätte gelogen. Wäre die Veröffentlichung dann falsch gewesen?',
        tutorEnglish: 'Suppose a source had lied. Would publication then have been wrong?',
        task: 'Distinguish outcome from decision quality using counterfactual language.',
        keywords: <String>['ex ante', 'im nachhinein', 'sorgfalt', 'ergebnis', 'entscheidungsqualität', 'hätte'],
        requiredHits: 3,
        minWords: 26,
        modelAnswer: 'Man muss die Entscheidungsqualität ex ante von der Ergebnisbewertung im Nachhinein trennen. '
      ...
      DialogueStep(
        ...
        keywords: <String>['im gegenteil', 'maßstab', 'gerade', 'unterscheidet', 'nachlässig', 'anspruchsvoll'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Im Gegenteil: Gerade dieser Maßstab unterscheidet sorgfältige von nachlässiger Arbeit. '
      ...
      DialogueStep(
        ...
        keywords: <String>['verbindlich', 'offenlegen', 'unabhängig', 'wäre', 'forderung', 'transparent'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Meine Forderung wäre schlicht: Redaktionen sollten ihre Abwägungskriterien verbindlich offenlegen '
            'und eine unabhängige Instanz sollte deren Anwendung stichprobenartig prüfen.',
        modelAnswerEnglish: 'My demand would be simple: newsrooms should disclose their weighing criteria bindingly '
  ...
  ConversationScenario(
    ...
    setting: 'A long-standing partner asks you to join a project you consider flawed.',
    ...
    steps: <DialogueStep>[
      DialogueStep(
        tutorGerman: 'Wir würden Sie gern als fachliche Leitung gewinnen. Was sagen Sie?',
        tutorEnglish: 'We would love to win you as technical lead. What do you say?',
        task: 'Acknowledge the offer warmly before signalling reservation.',
        keywords: <String>['schätze', 'freut', 'gleichwohl', 'zunächst', 'vertrauen', 'offen'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Das Angebot ehrt mich, und ich schätze das Vertrauen sehr. Gleichwohl möchte ich offen sein: '
            'Ich habe erhebliche Vorbehalte gegenüber der derzeitigen Anlage des Projekts.',
        modelAnswerEnglish: 'The offer honours me and I greatly value the trust. Nevertheless I want to be open: '
        ...
        coachTip: 'Warmth first, reservation second — reversing this reads as rejection of the person.',
      ),
      DialogueStep(
        tutorGerman: 'Vorbehalte? Die Finanzierung steht doch, das Team ist erfahren.',
        tutorEnglish: 'Reservations? The funding is secured, the team is experienced.',
        task: 'Name the substantive objection precisely, without insulting anyone.',
        keywords: <String>['weniger', 'sondern', 'zielsetzung', 'methodisch', 'zweifel', 'operationalisierung'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Meine Zweifel betreffen weniger die Ausstattung als die methodische Anlage: '
            'Die zentrale Zielgröße ist meines Erachtens nicht sauber operationalisiert, und darauf baut die gesamte Auswertung auf.',
        modelAnswerEnglish: 'My doubts concern the resourcing less than the methodological design: '
        ...
        coachTip: 'Criticise the design, never the designers — the sentence structure does the diplomacy.',
      ),
      DialogueStep(
        ...
        keywords: <String>['erfahrungsgemäß', 'nachträglich', 'vergleichbar', 'würde man', 'wären', 'neu beginnen', 'daten'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Erfahrungsgemäß eher nicht: Würde man die Zielgröße nachträglich ändern, wären die bereits erhobenen Daten '
      ...
      DialogueStep(
        ...
        keywords: <String>['bitte verstehen', 'nicht als', 'im gegenteil', 'gerade weil', 'unredlich', 'zusagen'],
        requiredHits: 3,
        minWords: 24,
        modelAnswer: 'Bitte verstehen Sie das nicht als Abwertung Ihrer Arbeit — im Gegenteil. '
      ...
      DialogueStep(
        ...
        keywords: <String>['anbieten', 'beratend', 'begrenzt', 'workshop', 'zur verfügung', 'ohne'],
        requiredHits: 3,
        minWords: 22,
        modelAnswer: 'Was ich anbieten kann, wäre eine klar begrenzte beratende Rolle: '
            'ein zweitägiger Methodenworkshop und eine schriftliche Stellungnahme, ohne Leitungsverantwortung.',
        modelAnswerEnglish: 'What I can offer would be a clearly limited advisory role: '
        ...
        coachTip: 'A refusal that comes with a smaller yes is remembered as generosity.',
      ),
      DialogueStep(
        ...
        keywords: <String>['freut', 'schicke', 'freitag', 'termin', 'melde', 'skizze', 'gern'],
        requiredHits: 2,
        minWords: 18,
        modelAnswer: 'Das freut mich aufrichtig. Ich schicke Ihnen bis Freitag zwei Terminvorschläge '
            'und eine kurze Skizze dessen, was der Workshop leisten kann.',
        modelAnswerEnglish: 'That genuinely pleases me. I will send you two proposed dates by Friday '
            'and a short outline of what the workshop can achieve.',
        quickReplies: <String>['Ich schicke Ihnen bis Freitag zwei Terminvorschläge.'],
...
const List<ConversationScenario> conversationScenarios = <ConversationScenario>[
...
const List<FreeTalkPrompt> freeTalkPrompts = <FreeTalkPrompt>[
  FreeTalkPrompt(
    ...
    expectedPoints: <String>['Wer gehört dazu', 'Wo sie wohnen', 'Was sie machen'],
    usefulConnectors: <String>['und', 'auch', 'aber'],
    targetSeconds: 40,
    targetWords: 30,
    modelAnswer: 'Meine Familie ist nicht sehr groß. Ich habe eine Schwester und einen Bruder. '
  ...
  FreeTalkPrompt(
    ...
    targetSeconds: 40,
    targetWords: 30,
    modelAnswer: 'Am Samstag stehe ich spät auf. Dann gehe ich einkaufen und koche etwas. '
  ...
  FreeTalkPrompt(
    ...
    targetSeconds: 60,
    targetWords: 55,
    modelAnswer: 'Letztes Jahr bin ich mit einem Freund nach Hamburg gefahren. Wir sind drei Tage geblieben. '
  ...
  FreeTalkPrompt(
    ...
    targetSeconds: 60,
    targetWords: 55,
    modelAnswer: 'Am wichtigsten ist mir die Lage, weil ich ohne Auto lebe und zur Arbeit laufen möchte. '
  ...
  FreeTalkPrompt(
    ...
    expectedPoints: <String>['Eigene Position', 'Zwei Argumente', 'Gegenargument', 'Fazit'],
    usefulConnectors: <String>['meiner Meinung nach', 'einerseits', 'andererseits', 'trotzdem', 'zusammenfassend'],
    targetSeconds: 90,
    targetWords: 90,
    modelAnswer: 'Meiner Meinung nach ist ein vollständiges Verbot nicht sinnvoll. Einerseits lenken Handys im Unterricht stark ab, '
  ...
  FreeTalkPrompt(
    ...
    targetSeconds: 90,
    targetWords: 90,
    modelAnswer: 'Als ich neu in Deutschland war, habe ich keinen Termin beim Bürgeramt bekommen. '
  ...
  FreeTalkPrompt(
    id: 'ft-b2-01',
    level: CefrLevel.b2,
    question: 'Wie verändert Automatisierung die Arbeitswelt? Argumentiere differenziert.',
    questionEnglish: 'How is automation changing the world of work? Argue in a differentiated way.',
    expectedPoints: <String>['These', 'Zwei Belege', 'Einschränkung', 'Schlussfolgerung'],
    usefulConnectors: <String>['zwar … aber', 'allerdings', 'darüber hinaus', 'folglich', 'im Gegensatz dazu'],
    targetSeconds: 120,
    targetWords: 130,
    modelAnswer: 'Automatisierung verändert Tätigkeiten stärker als ganze Berufe. Zwar fallen einzelne Routineaufgaben weg, '
  ...
  FreeTalkPrompt(
    ...
    questionEnglish: 'To what extent can educational equity be measured at all?',
    expectedPoints: <String>['Begriffsklärung', 'Messprobleme', 'Beispiel', 'Abwägung', 'Position'],
    usefulConnectors: <String>['zunächst', 'insofern', 'gleichwohl', 'demgegenüber', 'letztlich'],
    targetSeconds: 150,
    targetWords: 170,
    modelAnswer: 'Zunächst wäre zu klären, was gemeint ist: Chancengleichheit beim Zugang oder Ergebnisgleichheit am Ende. '
  ...
  FreeTalkPrompt(
    id: 'ft-c2-01',
    level: CefrLevel.c2,
    question: 'Ist Objektivität in der Berichterstattung ein erreichbares Ziel oder eine nützliche Fiktion?',
    questionEnglish: 'Is objectivity in reporting an achievable goal or a useful fiction?',
    expectedPoints: <String>['Begriffliche Präzisierung', 'Stärkste Gegenposition', 'Eigene Abwägung', 'Konsequenz'],
    usefulConnectors: <String>['man müsste unterscheiden', 'zugestandenermaßen', 'gleichwohl', 'daraus folgt nicht', 'vielmehr'],
    targetSeconds: 180,
    targetWords: 210,
    modelAnswer: 'Man müsste zunächst zwischen Objektivität als Zustand und als regulativer Idee unterscheiden. '
  ...
  FreeTalkPrompt(
    ...
    expectedPoints: <String>['Position', 'Kosten', 'Wirkung', 'Einwand', 'Fazit'],
    usefulConnectors: <String>['grundsätzlich', 'allerdings', 'hinzu kommt', 'demgegenüber', 'unter dem Strich'],
    targetSeconds: 120,
    targetWords: 130,
    modelAnswer: 'Grundsätzlich halte ich den Gedanken für sympathisch, die Umsetzung jedoch für schwieriger als oft dargestellt. '
  ...
  FreeTalkPrompt(
    id: 'ft-c1-02',
    level: CefrLevel.c1,
    question: 'Welche Rolle sollte Fachwissen in politischen Entscheidungen spielen?',
    questionEnglish: 'What role should expertise play in political decisions?',
    expectedPoints: <String>['Unterscheidung', 'Grenzen der Expertise', 'Legitimation', 'Beispiel', 'Position'],
    usefulConnectors: <String>['zum einen', 'zum anderen', 'insofern', 'gleichwohl', 'daraus ergibt sich'],
    targetSeconds: 150,
    targetWords: 170,
    modelAnswer: 'Zu unterscheiden wäre zwischen der Beschreibung von Sachverhalten und der Bewertung von Zielen. '
  ...
  FreeTalkPrompt(
    id: 'ft-c2-02',
    level: CefrLevel.c2,
    question: 'Lässt sich moralischer Fortschritt sinnvoll behaupten, oder ist das nur Selbstbeschreibung der Gegenwart?',
    questionEnglish: 'Can moral progress be meaningfully claimed, or is it merely the present describing itself?',
    expectedPoints: <String>['Problemstellung', 'Stärkste Gegenposition', 'Kriterium', 'Abwägung', 'Konsequenz'],
    usefulConnectors: <String>['zunächst wäre einzuwenden', 'zugestandenermaßen', 'gleichwohl', 'vielmehr', 'letztlich'],
    targetSeconds: 180,
    targetWords: 210,
    modelAnswer: 'Zunächst wäre einzuwenden, dass jede Fortschrittsbehauptung einen Maßstab voraussetzt, '
