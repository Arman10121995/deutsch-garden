...
const List<Story> _a1Stories = <Story>[
  Story(
    ...
    chapters: <StoryChapter>[
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Der Zug hält. Amir steigt aus.', 'The train stops. Amir gets off.'),
  ...
  Story(
    ...
    blurb: 'Lena parks her bike outside the library. It is not there afterwards.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-a1-02-c1',
        ...
        lines: <StoryLine>[
          StoryLine('Lena fährt jeden Tag mit dem Fahrrad.', 'Lena rides her bicycle every day.'),
          StoryLine('Heute geht sie in die Bibliothek.', 'Today she is going to the library.'),
          StoryLine('Sie stellt das Fahrrad vor die Tür.', 'She puts the bicycle in front of the door.'),
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          ...
          StoryLine('Jetzt kauft Lena immer ein gutes Schloss.', 'Now Lena always buys a good lock.'),
        ],
        glossary: <StoryGloss>[
  ...
  Story(
    ...
    chapters: <StoryChapter>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Der Strand war fast leer, weil es kühl war.', 'The beach was almost empty because it was cool.'),
  ...
  Story(
    ...
    chapters: <StoryChapter>[
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Herr Tanaka wohnt seit zwölf Jahren im dritten Stock.', 'Mr Tanaka has lived on the third floor for twelve years.'),
          StoryLine('Er kennt fast niemanden im Haus.', 'He knows almost nobody in the building.'),
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Seitdem kochen sie jeden Dienstag zusammen.', 'Since then they cook together every Tuesday.'),
          StoryLine('Ayla bringt Gemüse mit, Herr Tanaka macht die Suppe.', 'Ayla brings vegetables, Mr Tanaka makes the soup.'),
          StoryLine('Manchmal kommt auch die alte Dame aus dem ersten Stock.', 'Sometimes the old lady from the first floor comes too.'),
          StoryLine('Das Treppenhaus ist nicht mehr so still wie früher.', 'The stairwell is not as quiet as it used to be.'),
          StoryLine('Herr Tanaka sagt, der Rauch war das Beste, was passiert ist.', 'Mr Tanaka says the smoke was the best thing that happened.'),
          StoryLine('Ayla lacht jedes Mal, wenn er das erzählt.', 'Ayla laughs every time he tells that.'),
        ],
        glossary: <StoryGloss>[
...
const List<Story> _b1Stories = <Story>[
  Story(
    ...
    blurb: 'Nour needs one internship to finish her degree. There are 200 applicants.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-b1-01-c1',
        title: 'Die Absage',
        ...
        lines: <StoryLine>[
          ...
          StoryLine('Zum ersten Mal fiel ihr auf, dass sie in jedem Anschreiben dasselbe geschrieben hatte.', 'For the first time she noticed that she had written the same thing in every cover letter.'),
          StoryLine('Vielleicht lag das Problem nicht nur an den Firmen.', 'Perhaps the problem was not only with the companies.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Statt wieder zwanzig Bewerbungen zu verschicken, wählte sie drei Firmen aus.', 'Instead of sending twenty applications again, she selected three companies.'),
          StoryLine('Über jede las sie so viel, dass sie deren Projekte hätte erklären können.', 'She read so much about each that she could have explained their projects.'),
          StoryLine('In ihrem Anschreiben nannte sie ein konkretes Problem, an dem die Firma arbeitete.', 'In her cover letter she named a concrete problem the company was working on.'),
          StoryLine('Dann schrieb sie, was sie im Studium dazu gemacht hatte.', 'Then she wrote what she had done on that in her studies.'),
          StoryLine('Es fühlte sich riskanter an, weil sie viel mehr Zeit in weniger Bewerbungen steckte.', 'It felt riskier, because she put much more time into fewer applications.'),
          StoryLine('Aber diesmal antwortete eine Firma bereits nach zwei Tagen.', 'But this time a company replied after only two days.'),
          StoryLine('Sie wurde zu einem Gespräch eingeladen.', 'She was invited to an interview.'),
        ],
        glossary: <StoryGloss>[
    ...
    chapters: <StoryChapter>[
      StoryChapter(
        ...
        lines: <StoryLine>[
          ...
          StoryLine('Stattdessen schloss er den Laptop und ging spazieren.', 'Instead he closed the laptop and went for a walk.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          ...
          StoryLine('Streit gibt es trotzdem — aber selten wegen vier Zeilen.', 'There are still arguments — but rarely because of four lines.'),
        ],
        glossary: <StoryGloss>[
  ...
  Story(
    ...
    chapters: <StoryChapter>[
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Die Abweichung betrug lediglich zwei Prozent und lag damit innerhalb der Toleranz.', 'The deviation was merely two percent and therefore lay within tolerance.'),
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Milena schrieb den Bericht an einem Wochenende, ohne dass jemand sie darum gebeten hätte.', 'Milena wrote the report over a weekend without anyone having asked her to.'),
          StoryLine('Sie verzichtete bewusst auf jede Dramatisierung und beschränkte sich auf die Daten.', 'She deliberately avoided any dramatisation and confined herself to the data.'),
          StoryLine('Statt eine Ursache zu behaupten, listete sie drei mögliche Erklärungen auf.', 'Instead of asserting a cause, she listed three possible explanations.'),
          StoryLine('Für jede Erklärung schlug sie einen Test vor, der wenig kostete.', 'For each explanation she proposed a test that cost little.'),
          StoryLine('Dann schickte sie das Dokument an ihren Vorgesetzten — und in Kopie an niemanden sonst.', 'Then she sent the document to her supervisor — with a copy to nobody else.'),
          StoryLine('Diese Zurückhaltung sollte sich später als entscheidend erweisen.', 'This restraint would later prove decisive.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Ihr Vorgesetzter meldete sich erst nach elf Tagen, dafür mit einem Termin.', 'Her supervisor got back to her only after eleven days, but with a meeting.'),
          StoryLine('Der zweite Test bestätigte eine der drei Hypothesen: ein Ventil schloss zunehmend träge.', 'The second test confirmed one of the three hypotheses: a valve was closing increasingly sluggishly.'),
          StoryLine('Bis zum Ausfall hätte es vermutlich noch Monate gedauert, aber der Ausfall wäre teuer geworden.', 'It would probably have taken months until failure, but the failure would have been expensive.'),
          StoryLine('In der Auswertung erwähnte niemand, dass Milena den Hinweis gegeben hatte.', 'In the evaluation nobody mentioned that Milena had given the tip.'),
          StoryLine('Ihr Vorgesetzter jedoch fragte sie ab da bei jeder Unregelmäßigkeit als Erste.', 'Her supervisor, however, from then on asked her first at every irregularity.'),
          StoryLine('Manche Anerkennung steht nicht im Protokoll.', 'Some recognition does not appear in the minutes.'),
        ],
        glossary: <StoryGloss>[
...
const List<Story> _b2ExtraStories = <Story>[
  Story(
    ...
    blurb: 'At thirty-eight, Tobias gives up a secure job for an uncertain one.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-b2-02-c1',
        ...
        lines: <StoryLine>[
          StoryLine('Von außen betrachtet gab es keinen einzigen Grund zu kündigen.', 'Viewed from outside there was not a single reason to resign.'),
          StoryLine('Unbefristeter Vertrag, verlässliches Gehalt, ein Team, das ihn schätzte.', 'Permanent contract, reliable salary, a team that valued him.'),
          StoryLine('Und dennoch stellte Tobias seit zwei Jahren morgens dieselbe Frage.', 'And yet for two years Tobias had been asking himself the same question every morning.'),
          StoryLine('Nicht, ob die Arbeit schlecht war — sondern ob sie noch zu ihm gehörte.', 'Not whether the work was bad — but whether it still belonged to him.'),
          StoryLine('Freunde rieten ihm, dankbar zu sein, und sie hatten nicht unrecht.', 'Friends advised him to be grateful, and they were not wrong.'),
          StoryLine('Dankbarkeit und Zufriedenheit sind allerdings nicht dasselbe.', 'Gratitude and contentment are, however, not the same thing.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Statt spontan zu kündigen, gab er sich ein Jahr und ein Budget.', 'Instead of resigning spontaneously, he gave himself a year and a budget.'),
          StoryLine('Abends unterrichtete er Musik, zunächst zwei Schüler, später neun.', 'In the evenings he taught music, at first two pupils, later nine.'),
          StoryLine('Erst als der Nebenverdienst die Miete deckte, sprach er mit seiner Chefin.', 'Only when the side income covered the rent did he speak to his boss.'),
          StoryLine('Sie reagierte gelassener, als er befürchtet hatte, und bot ihm eine Teilzeitstelle an.', 'She reacted more calmly than he had feared and offered him a part-time position.'),
          StoryLine('Damit war das Risiko halbiert, ohne dass die Entscheidung verwässert wurde.', 'That halved the risk without watering down the decision.'),
          StoryLine('Rückblickend war nicht der Mut entscheidend, sondern die Vorbereitung.', 'In retrospect it was not the courage that mattered, but the preparation.'),
        ],
        glossary: <StoryGloss>[
...
const List<Story> _c1Stories = <Story>[
  Story(
    ...
    blurb: 'A promising result does not survive a second look. The deadline does not care.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-c1-01-c1',
        ...
        lines: <StoryLine>[
          StoryLine('Der Effekt war so deutlich, dass Hanna ihn zunächst für einen Fehler hielt.', 'The effect was so clear that Hanna initially took it for an error.'),
          StoryLine('Drei Wochen vor Abgabe des Zwischenberichts hätte sie ihn schlicht berichten können.', 'Three weeks before the interim report was due she could simply have reported it.'),
          StoryLine('Niemand hätte nachgefragt, zumal die Förderlinie auf genau solche Befunde ausgerichtet war.', 'Nobody would have asked, especially as the funding line was geared precisely to such findings.'),
          StoryLine('Gerade das machte sie misstrauisch: Ergebnisse, die perfekt in die Erwartung passen, verdienen die härteste Prüfung.', 'Precisely that made her suspicious: results that fit expectations perfectly deserve the hardest scrutiny.'),
          StoryLine('Sie zog die Rohdaten heran und rekonstruierte die Auswertung von Grund auf.', 'She pulled up the raw data and reconstructed the analysis from scratch.'),
          StoryLine('Nach elf Stunden fand sie den Punkt, an dem eine Filterbedingung zweimal angewendet worden war.', 'After eleven hours she found the point at which a filter condition had been applied twice.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          ...
          StoryLine('Nach zwanzig Minuten strich er den Absatz selbst.', 'After twenty minutes he deleted the paragraph himself.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Der Bericht ging pünktlich raus, mit einem unauffälligen Ergebnis und einer sehr auffälligen Fußnote.', 'The report went out on time, with an inconspicuous result and a very conspicuous footnote.'),
          StoryLine('Darin war der ursprüngliche Fehler offen beschrieben, einschließlich der Korrektur.', 'In it the original error was openly described, including the correction.'),
          StoryLine('Zwei Gutachter kritisierten den schwachen Effekt, ein dritter hob ausdrücklich die Transparenz hervor.', 'Two reviewers criticised the weak effect, a third explicitly highlighted the transparency.'),
          StoryLine('Im Folgejahr wurde das Projekt verlängert, allerdings mit einem geänderten Design.', 'The following year the project was extended, though with a modified design.'),
          StoryLine('Hanna wurde später gefragt, ob sich die elf Stunden gelohnt hätten.', 'Hanna was later asked whether the eleven hours had been worth it.'),
          StoryLine('Ihre Antwort war unspektakulär: Man wisse nie, welche Arbeit einen Schaden verhindert habe.', 'Her answer was unspectacular: one never knows which piece of work prevented a damage.'),
        ],
        glossary: <StoryGloss>[
  ...
  Story(
    ...
    blurb: 'After nineteen years abroad, a village looks smaller than memory allowed.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-c1-02-c1',
        ...
        lines: <StoryLine>[
          StoryLine('Nichts war so verändert, wie er befürchtet hatte, und gerade das irritierte ihn.', 'Nothing had changed as much as he had feared, and precisely that unsettled him.'),
          StoryLine('Die Straße, die in seiner Erinnerung eine Allee gewesen war, maß knapp vierzig Meter.', 'The street which in his memory had been an avenue measured barely forty metres.'),
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Das Elternhaus stand leer, seit seine Mutter ins Heim gezogen war.', 'The family home had stood empty since his mother moved into a care home.'),
          StoryLine('Verkaufen wäre vernünftig gewesen; halten war es nicht, aber es war ehrlicher.', 'Selling would have been sensible; keeping it was not, but it was more honest.'),
          StoryLine('In der Küche fand er eine Liste, auf der seine Mutter Wörter notiert hatte, die sie zu vergessen begann.', 'In the kitchen he found a list on which his mother had noted words she was beginning to forget.'),
          StoryLine('Sie war alphabetisch geordnet, was ihn mehr erschütterte als die Wörter selbst.', 'It was ordered alphabetically, which shook him more than the words themselves.'),
          StoryLine('Er beschloss, ein Jahr zu bleiben, ohne sich zu erklären, warum.', 'He decided to stay for a year, without explaining to himself why.'),
          StoryLine('Manche Entscheidungen begründet man erst rückblickend, und einige nie.', 'Some decisions one justifies only in retrospect, and some never.'),
        ],
        glossary: <StoryGloss>[
...
const List<Story> _c2Stories = <Story>[
  Story(
    ...
    blurb: 'An expert is asked for certainty she does not have, by people who need it.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-c2-01-c1',
        ...
        lines: <StoryLine>[
          StoryLine('Was von ihr verlangt wurde, war nicht eigentlich ein Gutachten, sondern eine Entlastung.', 'What was demanded of her was not really an expert opinion, but an exoneration.'),
          StoryLine('Der Auftrag war so formuliert, dass jede vorsichtige Antwort bereits als Zustimmung gelesen werden konnte.', 'The commission was worded so that any cautious answer could already be read as consent.'),
          StoryLine('Hätte sie lediglich die gestellte Frage beantwortet, wäre ihr sachlich nichts vorzuwerfen gewesen.', 'Had she merely answered the question posed, nothing could have been held against her substantively.'),
          StoryLine('Genau darin bestand die Konstruktion: Man wollte eine korrekte Antwort auf eine schief gestellte Frage.', 'That was precisely the construction: they wanted a correct answer to a crookedly posed question.'),
          StoryLine('Sie beschloss daher, das Gutachten mit einer Umformulierung der Fragestellung zu eröffnen.', 'She therefore decided to open the opinion by reformulating the question.'),
          StoryLine('Nichts an diesem Verfahren war unüblich; unüblich war lediglich, es sichtbar zu machen.', 'Nothing about this procedure was unusual; what was unusual was only making it visible.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Zitiert wurde am Ende nur der eine Satz, der sich am leichtesten missverstehen ließ.', 'In the end only the one sentence that was easiest to misunderstand was quoted.'),
          StoryLine('Dagegen ließ sich wenig unternehmen, und sie unternahm bewusst wenig.', 'Little could be done about that, and she deliberately did little.'),
          StoryLine('Wer jede Verkürzung korrigiert, wird zum Kommentator seiner eigenen Arbeit.', 'Whoever corrects every abbreviation becomes a commentator on their own work.'),
          StoryLine('Zwei Jahre später wurde das Verfahren geändert — mit einer Begründung, die ihrem Gutachten auffällig ähnelte.', 'Two years later the procedure was changed — with a justification that resembled her opinion strikingly.'),
          StoryLine('Ihr Name kam darin nicht vor, ihre Argumentation jedoch nahezu wörtlich.', 'Her name did not appear in it, her argument, however, almost verbatim.'),
          StoryLine('Sie hat das nie als Kränkung verstanden, sondern als das übliche Verfahren, in dem Sätze überleben und Namen nicht.', 'She never understood this as an insult, but as the usual procedure in which sentences survive and names do not.'),
        ],
        glossary: <StoryGloss>[
  ...
  Story(
    ...
    blurb: 'A collection is complete. Completeness turns out to be the problem.',
    chapters: <StoryChapter>[
      StoryChapter(
        id: 'st-c2-02-c1',
        title: 'Die Lücke',
        ...
        lines: <StoryLine>[
          StoryLine('Vollständigkeit gilt in Archiven als Ideal, obwohl sie streng genommen nie erreichbar ist.', 'Completeness is regarded as an ideal in archives, although strictly speaking it is never attainable.'),
          StoryLine('Was aufbewahrt wurde, verdankt sich stets einer Reihe von Entscheidungen, die selbst selten dokumentiert sind.', 'What was preserved is always owed to a series of decisions that are themselves rarely documented.'),
          StoryLine('Insofern ist ein Archiv weniger ein Abbild der Vergangenheit als ein Protokoll ihrer Bewertung.', 'In that respect an archive is less an image of the past than a record of its evaluation.'),
          StoryLine('Frau Selter hatte diesen Satz zwanzig Jahre lang gesagt, ehe er ihr selbst unangenehm wurde.', 'Ms Selter had said this sentence for twenty years before it became uncomfortable to her herself.'),
          StoryLine('Unangenehm wurde er, als sie in Kiste 41 einen Ordner fand, der laut Findbuch nicht existierte.', 'It became uncomfortable when she found a folder in box 41 that, according to the finding aid, did not exist.'),
        ],
        glossary: <StoryGloss>[
      ...
      StoryChapter(
        ...
        lines: <StoryLine>[
          StoryLine('Der Ordner enthielt nichts Skandalöses, sondern etwas weit Unbequemeres: Belanglosigkeiten.', 'The folder contained nothing scandalous, but something far more inconvenient: trivialities.'),
          StoryLine('Er dokumentierte, wie beiläufig damals über Aufnahme und Ausschluss entschieden worden war.', 'It documented how casually decisions on inclusion and exclusion had been made back then.'),
          StoryLine('Hätte sie ihn stillschweigend eingeordnet, wäre der Bestand formal korrekt und faktisch geschönt gewesen.', 'Had she filed it silently, the holdings would have been formally correct and factually embellished.'),
          StoryLine('Sie entschied sich, den Fund samt Kommentar zu verzeichnen, und rechnete mit Widerspruch.', 'She decided to record the find together with a commentary, and reckoned with objection.'),
          StoryLine('Der Widerspruch kam, allerdings leiser und höflicher, als sie erwartet hatte.', 'The objection came, though quieter and more polite than she had expected.'),
          StoryLine('Am Ende überlebte der Kommentar, weil niemand eine Begründung für seine Streichung formulieren mochte.', 'In the end the commentary survived because nobody cared to formulate a justification for deleting it.'),
        ],
        glossary: <StoryGloss>[
